...
class Parser:
    ...
    def map_tex2tei(self, s):
        ...
        s = re.sub(r'\\VD16\s*\\href\{([^\{\}]*)\}\{([^\{\}]*)\}', r'<bibl source="b652">VD16</bibl> <ref target="\1">\2</ref>', s, flags=re.S)
        s = re.sub(r'\\HBCite\{VD16\}\s*\\href\{([^\{\}]*)\}\{([^\{\}]*)\}', r'<bibl source="b652">VD16</bibl> <ref target="\1">\2</ref>', s, flags=re.S)
